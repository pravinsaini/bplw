...
<div style="width:100%; background-color:#211d70; font-size:20px; font-weight:bold; color:#FFFFFF; height:30px; line-height:30px; text-align:center;">Library Floor Map</div>
					...
					<br/>
						...
						<tr>
                                <td>                                  
									...
									<tr>
									<td>
                                    <a href="../images/ground_floor.jpg" class="galleryColBox" title="ground_floor " rel="imgGallery1">
                                    <img height="100" alt='Ground Floor' style="border:1px solid #ABABAB" width="190" src='../images/ground_floor.jpg'/>                             
                                    </a>
                                    <div class="desc" style="width:190" align="center"><p class="title">Ground Floor<br/><hr/></p></div>                                   
                                    </td>
									</tr>
									</table>									
                                </td>
								<td>                                  
									...
									<tr>
									<td>
                                    <a href="../images/first_floor.jpg" class="galleryColBox" title="first_floor" rel="imgGallery2">
                                    <img height="100" alt='First Floor' style="border:1px solid #ABABAB" width="190" src='../images/first_floor.jpg'/>                             
                                    </a>
                                    <div class="desc" style="width:190" align="center"><p class="title">First Floor<br/><hr/></p></div>                          
                                    </td>
									</tr>
									</table>						
                                </td>							
