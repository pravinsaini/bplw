...
function Validate(){
	...
	if(book_cover.value.trim() == ''){
		valid = false;
		message = message + '*Cover Image is required' + '\n';
	}
	if (valid == false){
		alert(message);
		return false;
...
<form action="add_book_of_the_month.php" method="post" enctype="multipart/form-data" onSubmit="return Validate();">
<?php				
$message="";
...
if($_FILES['book_cover']['type'] != 'image/jpeg' &&  $_FILES['book_cover']['type'] != 'image/jpg' &&  $_FILES['book_cover']['type'] != 'image/gif' && $_FILES['book_cover']['type'] != 'image/png')
			{
			...
			{					
						...
						$book_filetmp = $_FILES["book_cover"]["tmp_name"];						
						$book_file_name = $_FILES["book_cover"]["name"];
						$ext = pathinfo($book_file_name, PATHINFO_EXTENSION);
						$book_filename = $rand_date.".".$ext;
						$book_filepath = "../uploads/book_of_the_month/".$book_filename; 
						move_uploaded_file($book_filetmp,$book_filepath);
						
$sql = 'insert into book_of_the_month_main(book_title, book_author, book_image_path, date) 
		values("'.$book_title.'", "'.$book_author.'", "'.$book_filename.'", "'.$date.'")'; 
					...
					$message ='Book details has been uploaded successfully!!!';
			}
}
?>
...
<table align="center" cellpadding="0" cellspacing="0" >
								<tr>
								 <td align="right" style="color: #211D70;">Book Title:&nbsp;&nbsp;&nbsp;</td>
								 ...
								 <tr>
								 <td align="right" style="color: #211D70;">Book Author:&nbsp;&nbsp;&nbsp;</td>
								 <td><input type="text" name="book_author"  id="book_author" placeholder="&nbsp;" class="text_box"/></td>								 
								 </tr>
								 <tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>
								<tr>
								<td align="right" style="color: #211D70;">Book Cover:&nbsp;&nbsp;&nbsp;</td>
...
&nbsp;&nbsp;&nbsp;&nbsp;<a href="add_book_of_the_month.php" style="padding: 4px 15px 4px 15px; width:80px; background-color :#06588f; color: #FFFFFF; font-weight: bold; border-radius: 5px; font-size:14px;">Reset</a>
</td>
</tr>
</table>
<br><br>
