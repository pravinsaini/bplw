...
<tr style="line-height: 27px">
			...
			<tr><td align="left" style="padding:5px; border-bottom:1px solid #4a9ace;"><img src="../images/list_style_type_icon.png" style="width:12px; height:12px; vertical-align:middle;"/>&nbsp;<a href="books@mydesk.php" style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px;">Books@MyDesk</a></td></tr>
...
<td valign="top">
<table align="left" style="width: 200px; cellpadding="0" cellspacing="0" >
<tr style="line-height: 27px">
			<td style="background-color: #06588f; color: #FFFFFF; font-weight: bold; font-size:13px; border-top-left-radius:4px; border-top-right-radius:4px;" align="center">Important contacts Home</td></tr></table>
			<br/>
<div class="hidden_box_right_panel">
<br/>
<br/>
<br/>
<div style="color: #06588f; font-weight: bold; font-size:12px;" align="center"><u>Important contacts</u>
<br/><br/>
...
<tr style="color:#FFFFFF; background-color:#4a9ace; font-weight:bold; font-size:14px;">
						<th>
						<table align="center"><tr><td align="center" style="color:#FFFFFF; background-color:#4a9ace; font-size:14px; font-weight:bold; line-height:20px; vertical-align:center;">Club Name</td></tr></table>								
						</th>
						<th>
						<table align="center"><tr><td align="center" style="color:#FFFFFF; background-color:#4a9ace; font-size:14px; font-weight:bold; line-height:20px; vertical-align:center;">Person Name</td></tr></table>							
						</th>
						<th>
						...
						<th>
						<table align="center"><tr><td align="center" style="color:#FFFFFF; background-color:#4a9ace; font-size:14px; font-weight:bold; line-height:20px; vertical-align:center;">Mobile No.</td></tr></table>	
						</th>						
					</tr>
				</thead>
			<tr><td style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px; padding:5px; border-bottom:1px solid #4a9ace; border-right:1px solid #4a9ace;" align="center">Pegasus Club</td>
			<td style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px; padding:5px; border-bottom:1px solid #4a9ace; border-right:1px solid #4a9ace;" align="center">Priyank</td>
			<td style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px; padding:5px; border-bottom:1px solid #4a9ace; border-right:1px solid #4a9ace;" align="center">f2013852@pilani.bits-pilani.ac.in</td>
			<td style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px; padding:5px; border-bottom:1px solid #4a9ace;" align="center">7728086603</td>
			</tr>
			<tr><td style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px; padding:5px; border-right:1px solid #4a9ace;" align="center">Pegasus Club</td>
			<td style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px; padding:5px; border-right:1px solid #4a9ace;" align="center">Roshni</td>
			<td style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px; padding:5px; border-right:1px solid #4a9ace;" align="center"> f2013661@pilani.bits-pilani.ac.in</td>
			<td style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px; padding:5px;" align="center">8233155454</td>
			</tr>
			</table>
<br/><br/>
</div>
