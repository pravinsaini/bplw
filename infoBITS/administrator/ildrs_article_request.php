...
<title>Inter Library Document Request</title>
...
?>
<li>Inter Library Document Request</li>
</ul>
</div>
</div>
...
<tr style="line-height: 27px">
			<td style="background-color: #06588f; color: #FFFFFF; font-weight: bold; font-size:13px;" align="center">IL Document Request Home</td></tr>
...
<tr style="line-height: 27px">
			<td style="background-color: #06588f; color: #FFFFFF; font-weight: bold; font-size:13px; border-top-left-radius:4px; border-top-right-radius:4px;" align="center">Document Requests</td>
</tr></table>
<br/>
<div class="hidden_box_right_panel">
<?php				
		$message="";
		$query = "select * from ildrs Order by id DESC"; 
...
while($row = mysql_fetch_array($result))
				...
				<form method="post" action="ildrs_article_request_details.php">
