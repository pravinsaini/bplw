...
<tr style="line-height: 27px">
			<td style="background-color: #06588f; color: #FFFFFF; font-weight: bold; font-size:13px;" align="center">Book of the month Home</td></tr>
			<tr><td align="left" style="padding:5px; border-bottom:1px solid #4a9ace;"><img src="../images/list_style_type_icon.png" style="width:12px; height:12px; vertical-align:middle;"/>&nbsp;<a href="add_book_of_the_month.php" style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px;">Add</a></td></tr>
			...
			<tr><td align="left" style="padding:5px; border-bottom:1px solid #4a9ace;"><img src="../images/list_style_type_icon.png" style="width:12px; height:12px; vertical-align:middle;"/>&nbsp;<a href="book_of_the_month_details.php" style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px;">Book Reservation Details</a></td></tr>
			</table>
</div></td>
<td style="width:20px;">&nbsp;</td>
<td valign="top">
<table align="left" style="width: 130px;" cellpadding="0" cellspacing="0" >
<tr style="line-height: 27px">
			<td style="background-color: #06588f; color: #FFFFFF; font-weight: bold; font-size:13px; border-top-left-radius:4px; border-top-right-radius:4px;" align="center">Details</td>
</tr></table>
<br/>
<div class="hidden_box_right_panel">
<?php				
		$message="";
		$query = "select * from book_of_the_month Order by id ASC"; 
			...
			<table align="center" style="width: 97%; background-color: #FFFFFF; color: #211D70; border: 1px solid #4a9ace;" cellpadding="0" cellspacing="0">
				<thead>
					<tr style="color:#FFFFFF; background-color:#4a9ace; font-weight:bold; font-size:14px;">					
						...
						<th>
						<table align="center"><tr><td align="center" style="color:#FFFFFF; background-color:#4a9ace; font-size:14px; font-weight:bold; line-height:20px; vertical-align:center;">Time</td></tr></table>							
						</th>
						<th>
						<table align="center"><tr><td align="center" style="color:#FFFFFF; background-color:#4a9ace; font-size:14px; font-weight:bold; line-height:20px; vertical-align:center;">PSRN No.</td></tr></table>							
						</th>
						<th>
						...
						<th>
						<table align="center"><tr><td align="center" style="color:#FFFFFF; background-color:#4a9ace; font-size:14px; font-weight:bold; line-height:20px; vertical-align:center;">Book Title</td></tr></table>							
						</th>
					</tr>
				</thead>
<?php
