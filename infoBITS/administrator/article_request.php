...
<tr style="line-height: 27px">
			...
			<tr><td align="left" style="padding:5px; border-bottom:1px solid #4a9ace;"><img src="../images/list_style_type_icon.png" style="width:12px; height:12px; vertical-align:middle;"/>&nbsp;<a href="book_request.php" style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px;">Book Request</a></td></tr>
			<tr><td align="left" style="padding:5px; border-bottom:1px solid #4a9ace;"><img src="../images/list_style_type_icon.png" style="width:12px; height:12px; vertical-align:middle;"/>&nbsp;<a href="" style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px;">Article Request</a></td></tr>
			</table>
</div></td>
...
<tr style="line-height: 27px">
			<td style="background-color: #06588f; color: #FFFFFF; font-weight: bold; font-size:13px; border-top-left-radius:4px; border-top-right-radius:4px;" align="center">Article Request</td>
</tr></table>
<br/>
<div class="hidden_box_right_panel">
<?php				
		$message="";
		$query = "select * from ill_article_request Order by id DESC"; 
...
while($row = mysql_fetch_array($result))
				...
				<form method="post" action="article_request_details.php">
