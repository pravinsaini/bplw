...
<title>Lost & Found - Item Claimed</title>
...
<tr style="line-height: 27px">
			...
			<tr><td align="left" style="padding:5px;"><img src="../images/list_style_type_icon.png" style="width:12px; height:12px; vertical-align:middle;"/>&nbsp;<a href="" style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px;">Item Claimed</a></td></tr>
			</table>
</div></td>
...
<tr style="line-height: 27px">
			<td style="background-color: #06588f; color: #FFFFFF; font-weight: bold; font-size:13px; border-top-left-radius:4px; border-top-right-radius:4px;" align="center">Item Claimed</td>
			</tr></table>
			<br/>
...
$message="";
$total="";
$sql = "select * from lfms where status='0' order by Claim_Date DESC";
$result = mysql_query($sql);
$num_rows = mysql_num_rows($result);
if($result && mysql_num_rows($result)>0)
{
$total = "Total Number of Claimed Particulars are $num_rows";
?>
<br/>
<br/>
<div align="center"><span style="color:green; font-size:13px; font-weight:bold;"><?php echo $total;?></span></div>
<table align="center" style="width: 97%; background-color: #FFFFFF; color: #211D70; border: 1px solid #4a9ace;" cellpadding="0" cellspacing="0">
				<thead>
					<tr style="color:#FFFFFF; background-color:#4a9ace; font-weight:bold; font-size:14px;">					
						<th>
						<table align="center"><tr><td align="center" style="color:#FFFFFF; background-color:#4a9ace; font-size:14px; font-weight:bold; line-height:20px; vertical-align:center;">Claimed On</td></tr></table>							
						</th>
						<th>
						...
						<th>
						<table align="center"><tr><td align="center" style="color:#FFFFFF; background-color:#4a9ace; font-size:14px; font-weight:bold; line-height:20px; vertical-align:center;">Claimed No.</td></tr></table>							
						</th>
						<th>
						...
						<th>
						<table align="center"><tr><td align="center" style="color:#FFFFFF; background-color:#4a9ace; font-size:14px; font-weight:bold; line-height:20px; vertical-align:center;">Id/PSRN No.</td></tr></table>							
						</th>
						
						<th>
						<table align="center"><tr><td align="center" style="color:#FFFFFF; background-color:#4a9ace; font-size:14px; font-weight:bold; line-height:20px; vertical-align:center;">Action(Verify)</td></tr></table>
						</th>
					</tr>
				</thead>
<?php
while($row = mysql_fetch_array($result))
				...
				?>				
				<tr align="left">
<td style="background-color: #FFFFFF; color: #06588f; font-weight: bold; font-size:12px; padding:5px; border-bottom:1px solid #4a9ace; border-right:1px solid #4a9ace; width:100px;" align="center">
				<?php echo $row["Claim_Date"]; ?></td>				
				...
				<input type="submit" value="Verify" name="edit" class="Stylish_button" style="font-size: 13px; font-weight: bold;cursor: pointer;"/>
				</form>
				</td>							
				</tr>				
				<?php
