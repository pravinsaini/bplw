...
if(isset($_POST["action"]) and $_POST["action"]=="edit")
{
	...
	$sql = "select * from ill_article_request where id = $id";
...
while($row = mysql_fetch_array($result))
				...
				<table align="center" style="font-size:13px;" cellpadding="0" cellspacing="0">
								 ...
								 <tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>
								 <tr>
								 <td align="left" style="color: #211D70;">Author:&nbsp;</td>
								 <td><?php echo $row["author"]; ?></td>								 
								 </tr>
								 <tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>
								 <tr>
								 <td align="left" style="color: #211D70;">Title:&nbsp;</td>
								...
								<tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>
								<tr>	
								<td align="left" style="color: #211D70;">ISSN No.:&nbsp;</td>
								<td><?php echo $row["issn"]; ?></td>					
								</tr>
								<tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>	
								<tr style="line-height: 20px"><td colspan="2"><a href="article_request.php" style="padding: 4px 15px 4px 15px; width:80px; background-color :#06588f; color: #FFFFFF; font-weight: bold; border-radius: 5px; font-size:14px;">Back</a></td></tr>
								<tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>
					</table>
				</td>
				</tr>			
