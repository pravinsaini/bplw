...
<title>Matrix Club Archive</title>
...
?>
<li>Matrix Club Archive</li>
</ul>
</div>
</div>
<div class="bannerCarouselWrapper1">
<div class="service_box">
<div style="width:100%; background-color:#211d70; font-size:20px; font-weight:bold; color:#FFFFFF; height:30px; line-height:30px; text-align:center;">Matrix Club Archive</div>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" align="center">
                            <tr>
                                <td>                                  
									...
									<tr>
									<td>
                                    <a href="../uploads/creativeclub/matrix_club/Matrix write-up.jpg" class="galleryColBox" title="Matrix Club" rel="imgGallerym1">
                                    <img height="100" alt='Matrix Club' style="border:1px solid #ABABAB" width="190" src='../uploads/creativeclub/matrix_club/Matrix write-up.jpg'/>                             
                                    </a>
                                    <div class="desc" style="width:190" align="center"><p class="title">Write-Up<br/><hr/></p></div>                                   
                                    </td>
									</tr>
									</table>									
                                </td>								
