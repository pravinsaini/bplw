...
<title>Circulation Service</title>
...
<div class="heading">
<h2><span>Circulation</span> Service</h2>
</div>
<div class="description">
The BITS Pilani library has implemented KOHA open-source Integrated Library System and is fully automated. The entire collection of the library including Books, Bound Volumes, Theses, Reports and Audio Visual Resources are bar-coded and /or are part of Web  OPAC.  The members of the library are expected to present their Institute's  ID cards to get the books borrowed on their names.
<br /><br />
The books are issued for a period of two weeks and the entitlements for members are as follows:
<br /><br />
...
<br />
The books can be re-issued for another period of 2 weeks provided they are not reserved by other members.<br /><br />
Members are expected to pay overdue charges if they are returning books late. The reminders for overdue books are automatically generated and sent to members.Members can reserve a book that is out in circulation. When the returned, the member will be informed by e-mail/phone/SMS to collect the reserved book.The Library management system provides issue statistics for any given period, who borrows what, fast moving titles, List of overdue books etc.
<br />
</div>
</div>
</div>
