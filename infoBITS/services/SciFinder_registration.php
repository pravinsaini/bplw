...
<br/>
<br/>
<table align="center" style="font-size:13px; width:95%"><tr>
<td style="width:500px;"><span style="font-weight:bold; font-size:14px;color: #211D70;"><u>Registration Steps for Creating Account</u></span>
<div class="description">
<span style="font-weight:bold; font-size:14px;">Step 1</span>
<br/><span style="font-size:14px;"> 
Create your login ID for SciFinder web version by clicking on link below:</span>
<br/>
<a style="font-weight:bold; font-size:14px; color: #211D70;" target="_blank" href="https://scifinder.cas.org/registration/index.html?corpKey=D0A3609EX86F35055X3ED4517117449D5FD2">https://scifinder.cas.org/registration/index.html?corpKey=D0A3609EX86F35055X3ED4517117449D5FD2</a>
<br/><span style="font-size:14px;">
(If you see above link in two lines, then you need to copy/past/join in your browser and then click Go to visit it)</span>
<br/>
<span style="font-weight:bold; font-size:14px;">Step 2</span>
<br/> <span style="font-size:14px;">
You will receive confirmation email titled "SciFinder Registration - Your Confirmation Required" in few minutes.
<br/> 
Please click on the link email (in 48 Hrs) and activate your access</span>
<br/>
<span style="font-weight:bold; font-size:14px;">Step 3</span>
<br/><span style="font-size:14px;">
You can then visit <a style="font-weight:bold; font-size:15px; color: #211D70;" target="_blank" href="https://scifinder.cas.org">https://scifinder.cas.org</a> to use SciFinder web version!</span>
</td>
<td style="width:20px;">&nbsp;</td>
<td align="center" style="vertical-align:top;">
<span style="font-weight:bold; font-size:14px;">Click here to access SciFinder</span>
<br/>
<br/>
<a href="https://scifinder.cas.org" target="_blank">
<img src="../images/SciFinder_login.gif" style="border:1px solid black;">
</a>
</td>
</tr>
</table>
