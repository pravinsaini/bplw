...
<title>Inter Library Document Request Service</title>
...
?>
<li>Inter Library Document Request Service</li>
</ul>
</div>
</div>
...
<br/>
<div align="center" style="color: #211D70; font-size:18px; font-weight:bold;">Inter Library Document Request Form</div><br/>
<div align="center" style="color: #211D70; font-size:16px; font-weight:bold; text-decoration:underline;">For Article request</div>
<form action="ildrs.php" method="post" enctype="multipart/form-data" onSubmit="return Validate();">
<?php
...
$bitsid=$info['bitsid'];
		$name=$info['name'];
		$email=$info['email'];
				$query = 'insert into ildrs(author, title, journal_name, volume_number, issue_number, page_number, url, date, time, bitsid, name, email) 
					values("'.$author.'", "'.$title.'", "'.$journal_name.'", "'.$volume_number.'", "'.$issue_number.'", "'.$page_number.'", "'.$url.'", "'.$date.'", "'.$time.'", "'.$bitsid.'", "'.$name.'", "'.$email.'")'; 
...
<table align="center" cellpadding="0" cellspacing="0" >
								<tr>
								 <td colspan="2" align="left" style="color: #211D70;">I request the following articles for my Academic / Research purpose:</td>								 
								 </tr>
								<tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>
								<tr>
								 <td align="left" style="color: #211D70;">Title of the Article&nbsp;</td>
								 <td>:&nbsp;<input type="text" name="title"  id="title"placeholder="&nbsp;" class="text_box"/></td>													 
								 </tr>
								<tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>								 
								 <tr>
								 <td align="left" style="color: #211D70;">Author/s&nbsp;</td>
								 <td>:&nbsp;<input type="text" name="author"  id="author" placeholder="&nbsp;" class="text_box"/></td>								 
								 </tr>							 
								 <tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>
								<tr>
								<td align="left" style="color: #211D70;">Journal Name&nbsp;</td>
								...
								<table>
								<tr>
								<td align="left" style="color: #211D70;">Volume Number&nbsp;&nbsp;&nbsp;</td>
								<td>:&nbsp;<input type="text" name="volume_number"  id="volume_number" placeholder="&nbsp;" class="small_text_box"/></td>	
								<td align="left" style="color: #211D70;">&nbsp;&nbsp;Issue Number&nbsp;</td>
								<td>:&nbsp;<input type="text" name="issue_number"  id="issue_number" placeholder="&nbsp;" class="small_text_box"/></td>
								<td align="left" style="color: #211D70;">&nbsp;&nbsp;Page Number&nbsp;</td>
								<td>:&nbsp;<input type="text" name="page_number"  id="page_number" placeholder="&nbsp;" class="small_text_box"/></td>
								</tr>
								</table>
								</td>				
								</tr>
								<tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>
								<tr>	
								<td align="left" style="color: #211D70;">URL of the article&nbsp;</td>
								<td>:&nbsp;<input type="text" name="url"  id="url" placeholder="&nbsp;" class="text_box"/></td>					
								</tr>
								<tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>
								<tr></td><td colspan="2" valign="top" align="left"><table><tr><td valign="top"><input type="checkbox" value="agree" name="agree" id="agree" required ></input></td><td valign="top"><h2 style="font-size:14px; color: #211D70;">I agree that the document will be used for my personal academic / research work only<br/> without any copyright violation.</h2></td></tr></table></td></tr>
								<tr style="line-height: 20px"><td colspan="2">&nbsp;</td></tr>
								<tr>
				<td>&nbsp;</td>
				<td align="left">
				<input type="submit" name="submit" value="Submit" class="Stylish_button" />
&nbsp;&nbsp;&nbsp;&nbsp;<a href="ildrs.php" style="padding: 4px 15px 4px 15px; width:80px; background-color :#06588f; color: #FFFFFF; font-weight: bold; border-radius: 5px; font-size:14px;">Reset</a>
</td>
</tr>
</table><br/>
</form>
