...
?>
<li>Audio Visuals Collection</li>
</ul>
</div>
</div>
...
<div class="heading">
<h2><span>Audio Visuals</span> Collection (1st Floor, AV Room)</h2>
</div>
<div class="description">
The BITS Library is developing a collection of Audio Visual resources including CDs, DVDs, Audio CDs. Currently, the collection includes a wide range of topics in Business and Management.<br /><br />
The users who are interesting in watching these DVDs in groups are expected to reserve the Audio Visual Room in advance by submitting the prescribed request form.<br /><br />
Users are not allowed  to copy these AV material and are strictly advised to adhere to copyright laws.
<br />
<br />
<br />
</div>
