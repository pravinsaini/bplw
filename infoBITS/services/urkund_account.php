...
if(isset($_SESSION['bitsid']))
{
	...
	if($info['category']=="Faculty/Staff" || $info['category']=="Admin")
	{	
?>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type">
<title>Urkund Anti-plagiarism software - Account</title>
...
<form action="urkund_account.php" method="post" enctype="multipart/form-data" onSubmit="return Validate();">
<?php
date_default_timezone_set("Etc/UTC");				
$message="";
if(isset($_POST['submit']))
{
$query='select * from urkund where bitsid="'.$_SESSION['bitsid'].'"';
...
$date = date("d/m/Y");
$time=  date('h:i:s');
				$query = 'insert into urkund(name, bitsid, email, department_name, date, time) 
					values("'.$name.'", "'.$bitsid.'", "'.$email.'", "'.$dep_name.'", "'.$date.'", "'.$time.'")'; 
...
?>
<div align="center">&nbsp;<span style="color:green; font-weight:bold;"><?php echo $message;?></span></div>
<div align="left" style="color:#211D70; font-size:14px; margin-left:220px;">
To,<br/><br/>
The Librarian,<br/>
BITS Pilani Library<br/><br/>
Dear Sir,<br/><br/>
I would like to have my account with URKUND Anti-plagiarism software.<br/>
My details are given below:<br/><br/>
</div>
<table align="left" cellpadding="0" cellspacing="0" style="color:#211D70; font-size:14px; margin-left:220px;">
								<tr>
									<td style="font-weight:bold;">Name</td>
									<td>
                                      :<input type="text" name="name" id="name" style="color:#211D70; border-radius:10px; font-size:13px; border:none; font-weight:normal;" value="<?php echo $info['name']; ?>" readonly="true"/>                
									</td>
								</tr>
                                <tr style="line-height: 10px"><td colspan="2">&nbsp;</td></tr>
						<tr>
					    <td style="font-weight:bold;">PSRN No.</td>
						<td>
                           :<input type="text" name="bitsid" id="bitsid" style="color:#211D70; border-radius:10px; font-size:13px; border:none; font-weight:normal;" value="<?php echo $info['bitsid']; ?>" readonly="true"/> 
						</td>   
					</tr>
                    <tr style="line-height: 10px"><td colspan="2">&nbsp;</td></tr>
                    <tr>
					    <td style="font-weight:bold;">BITS E-Mail ID</td>
						<td>
					:<input type="text" name="email" id="email" style="color:#211D70; border-radius:10px; font-size:13px; border:none; font-weight:normal; width: 250px;" value="<?php echo $info['email']; ?>" readonly="true"/>
						</td>  
					</tr>
                    <tr style="line-height: 10px"><td colspan="2">&nbsp;</td></tr>
<tr>	
						<td style="font-weight:bold;">Select Department<span class="error">*</span>&nbsp;</td>
                        <td>
						<?php 
...
<div class="description">
<br/>
<div align="center" class="error">You are not allow to access this page.</div>
<br/>
</div>
</div>
</div>
