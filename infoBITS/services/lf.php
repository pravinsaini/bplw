...
<div class="heading">
<h2><span>Lost</span> and Found</h2>
</div>
<div class="description">
The lost and found items by the library staff are kept separately in the library. These items are included in the "Lost and Found" page of the Library Portal.
<br /><br />
Steps to be followed to claim your lost items found in the library<br /><br />
1. Click the "Lost and Found" icon on your Dashboard to get the list of found items.<br/><br/>
2. If you notice your lost item, press Claim button - you will get a pop-up message    
   giving you a unique Identification No. <br/><br/>
3. Then meet the Librarian/ Library staff to claim your lost item by giving your unique 
    Identification no.<br/><br/>
4. Based on the description provided by you, the Librarian/ library staff will check and 
    verify to confirm that the found item belongs to you.<br/><br/>
5. You will then acknowledge having received the item online.<br/><br/>
6. The Librarian/ Library staff will hand over the lost item to you after the verification.
<br />
<br />
</div>
</div>
