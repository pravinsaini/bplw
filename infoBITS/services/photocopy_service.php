...
<div class="heading">
<h2><span>Photocopy</span> Service</h2>
</div>
<div class="description">
•	Photocopying of complete book is a violation of copyright law and therefore it is forbidden. Only 10% of a book is allowed.<br /><br />•	For, photocopy work of more than 20 pages (i.e continuous pages from one book/journal/theses), a <strong><i>Photocopy Request Form</i></strong> has to be submitted. The Form is available with the operator.<br /><br />•	Reference and Text books should not be left for photocopying at the photocopier to be collected later. This inconveniences other readers who need the same book. In case there is a rush, please come again during lull period and submit the same book for photocopying.<br /><br />•	During peak hours, photocopies of less than 10 pages will be given priority.
<br />
<br />
<br />
</div>
