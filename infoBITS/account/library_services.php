...
<div class="heading">
<h2><span>Library</span> Services</h2>
</div>
<table align="center" cellpadding="0" cellspacing="0" style="width:90%; background-color:#FFFFFF;">
<tr>
         <td align="center" ><a href="count.php?book_finder=../search/book_finder.php" name="book_finder" id="book_finder"><img src="../images/Book Finder For U.png" style="border:1px solid black; width: 120px; height:110px;"></a></td>
         <td align="center" ><a href="count.php?periodical_finder=../search/periodical_finder.php" name="periodical_finder" id="periodical_finder"><img src="../images/Periodical Finder.png" style=" border:1px solid black; width: 120px; height:110px;"></a></td>
         <td align="center" ><a href="count.php?daily_news=../services/daily_news.php" name="daily_news" id="daily_news"><img src="../images/Daily News.png" style="border:1px solid black; width: 120px; height:110px;"></a></td>  
         <td align="center" ><a href="count.php?bulletin=../services/bulletin.php" name="bulletin" id="bulletin"><img src="../images/info.png" style="border:1px solid black; width: 120px; height:110px;"></a></td>
		 </tr>
<tr style="line-height:25px"><td colspan="4">&nbsp;</td></tr>
<tr>
     <td align="center"><a href="count.php?ill=../services/ill.php" name="ill" id="ill"><img src="../images/ILL Logo.png" style="border:1px solid black; width: 120px; height:110px;"></a></td>
     <td align="center"><a href="count.php?lfms=../services/lfms.php" name="lfms" id="lfms"><img src="../images/lostandfound.jpg" style="border:1px solid black; width: 120px; height:110px;"></a></td> 
<td align="center">
<?php
if($userinfo['category']=="Admin" || $userinfo['category']=="Faculty/Staff")
{
?>
<a href="../services/urkund_account.php"><img src="../images/urkund_logo.jpg" style="border:1px solid black; width: 120px; height:110px;"></a>
<?php
}
?>
</td>
<td align="center">
<?php
if($userinfo['category']=="Faculty/Staff" || $userinfo['category']=="Admin")
{
?>
<a href="count.php?books_mydesk=../services/books@mydesk.php" name="books_mydesk" id="books_mydesk"><img src="../images/Books@MyDesk.png" style="border:1px solid black; width: 120px; height:110px;"></a>
<?php
}
?>
</td>  
